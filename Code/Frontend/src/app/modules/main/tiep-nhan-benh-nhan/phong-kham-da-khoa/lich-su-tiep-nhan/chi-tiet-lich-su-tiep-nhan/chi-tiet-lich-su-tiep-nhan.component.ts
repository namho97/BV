...
import { TiepNhanViewModel, ThongTinHanhChinhViewModel, ThongTinNguoiGiamHoViewModel, ThongTinBHYTViewModel, ThongTinTiepNhanViewModel } from '../../../tiep-nhan.model';
declare let $: any;

@Component({
  selector: 'app-chi-tiet-lich-su-tiep-nhan',
  templateUrl: './chi-tiet-lich-su-tiep-nhan.component.html',
  styleUrls: ['./chi-tiet-lich-su-tiep-nhan.component.scss']
})
export class ChiTietLichSuTiepNhanComponent implements OnInit {
  ...
  getColumnsDichVu() {
    this.columnsDichVu = [
      ...
      { label: 'TÊN DỊCH VỤ', property: 'TenDichVu', type: 'text', minWidth: 300, visible: true, footerLabel: "<strong>TỔNG CỘNG:</strong>" },
  ...
  extDataItemSelectedDichVu(event) {
  ...
  getColumnsLichHen() {
    this.columnsLichHen = [
      { label: 'TÊN DỊCH VỤ', property: 'TenDichVu', type: 'text', width: 300, visible: true },
  ...
  getColumnsLichSuKhamBenh() {
    this.columnsLichSuKhamBenh = [
      ...
      { label: 'TÊN DỊCH VỤ KHÁM', property: 'TenDichVuKham', type: 'text', minWidth: 200, visible: true },
