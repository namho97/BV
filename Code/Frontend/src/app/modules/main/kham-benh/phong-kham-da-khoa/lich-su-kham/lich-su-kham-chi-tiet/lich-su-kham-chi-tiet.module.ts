...
import { LichSuKhamChiTietKetQuaLsClsModule } from './lich-su-kham-chi-tiet-ket-qua-ls-cls/lich-su-kham-chi-tiet-ket-qua-ls-cls.module';
...
@NgModule({
  imports: [
    ...
    LichSuKhamChiTietKetQuaLsClsModule,
