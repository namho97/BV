...
namespace Camino.Services.QuanTris.NhomHanhChinhs
{
    ...
    public class ChucDanhService : MasterFileService<ChucDanh>, IChucDanhService
    {
        public ChucDanhService(IRepository<ChucDanh> repository) : base(repository)
        {
        }
        ...
        public async Task<GridDataSource> GetDataForGridAsync(ChucDanhQueryInfo queryInfo)
        {
