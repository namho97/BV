...
@Component({
  selector: 'app-chuc-vu-chi-tiet',
  templateUrl: './chuc-vu-chi-tiet.component.html',
  styleUrls: ['./chuc-vu-chi-tiet.component.scss']
})
export class ChucVuChiTietComponent implements OnInit {
  ...
  constructor(private dialog: MatDialog, private baseService: BaseService, private snackBar: MatSnackBar, private errorService: ErrorService,
    private chucVuService: ChucVuService, private authService: AuthService,
    private cdRef: ChangeDetectorRef) {
    this.baseService.controllerName = this.chucVuService.controllerName;
  }
