...
namespace Camino.Data
{
    public class CaminoObjectContext : DbContext
    {
        ...
        public CaminoObjectContext(DbContextOptions<CaminoObjectContext> options, IHttpContextAccessor httpContextAccessor) : base(options)
        {
        ...
        {
            long currentUserId = CaminoConstants.DefaultSystemUserId;
            var claimUserId = _httpContextAccessor.HttpContext?.User.Claims.FirstOrDefault(o => o.Type == CaminoConstants.JwtClaimTypes.Id);
            if (claimUserId != null)
            {
                currentUserId = long.Parse(claimUserId.Value);
            }
            ...
            foreach (var entry in ChangeTracker.Entries<BaseEntity>())
            {
                ...
                switch (entry.State)
                {
                    case EntityState.Added:
                        ...
                        entry.Entity.LastUserId = currentUserId;
                        break;
