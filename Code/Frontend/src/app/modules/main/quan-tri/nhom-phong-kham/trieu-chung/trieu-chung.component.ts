...
@Component({
  selector: 'app-trieu-chung',
  templateUrl: './trieu-chung.component.html',
  styleUrls: ['./trieu-chung.component.scss']
})
export class TrieuChungComponent implements OnInit {
  ...
  dataSource: any;
  @ViewChild("treeNhomDichVu", { static: true }) tree:TreeComponent;
