...
@Component({
  selector: 'app-tao-tiep-nhan',
  templateUrl: './tao-tiep-nhan.component.html',
  styleUrls: ['./tao-tiep-nhan.component.scss']
})
export class TaoTiepNhanComponent implements OnInit {
  ...
  @ViewChild("tableTaoTiepNhan", { static: true }) table:TableComponent;
