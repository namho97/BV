...
namespace Camino.Services.QuanTris.NhomHanhChinhs
{
    ...
    public class NgheNghiepService : MasterFileService<NgheNghiep>, INgheNghiepService
    {
        public NgheNghiepService(IRepository<NgheNghiep> repository) : base(repository)
        {
        }
        public async Task<GridDataSource> GetDataForGridAsync(NgheNghiepQueryInfo queryInfo)
        {
